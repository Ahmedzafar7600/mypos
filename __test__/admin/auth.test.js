...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Waino50',
      password: 'qfK751L0LOp0Z8b',
      email: 'Ashtyn_Romaguera60@yahoo.com',
      name: 'Dr. Dale Satterfield',
      shippingAddress: [
        {
          _id: false,
          pincode: 'Loan',
      ...
      userType: 860,
      mobileNo: '(697) 751-0092',
      resetPasswordLink: {},
      loginRetryLimit: 180,
      loginReactiveTime: '2023-09-06T13:18:08.238Z',
      id: '649211ddb628786f006caf54'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Shakira25',
        'password':'xCoKD56JseCkJdC',
        'email':'Travon_Mills@hotmail.com',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/admin/auth/forgot-password')
      .send({ 'email':'Travon_Mills@hotmail.com', });
