...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Godfrey.Yundt30',
      password: 'LLurGcU4EQ9KIjt',
      email: 'Flo45@gmail.com',
      name: 'Judy Graham',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 761,
      mobileNo: '(208) 606-1918',
      resetPasswordLink: {},
      loginRetryLimit: 776,
      loginReactiveTime: '2023-12-09T14:02:42.917Z',
      id: '649211ddb628786f006cb02c'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Austen58',
        'password':'JJwOx6TbrC0Z2ve',
        'email':'Zoila30@gmail.com',
        'name':'Christopher Treutel',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Shoes',
          'address1':'Stravenue',
