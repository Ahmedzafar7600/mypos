...
beforeAll(async function (){
  try {
    ...
    insertedUser = await user.insertOne({
      username: 'Jermain.Bednar',
      password: '44v9TWwLFcGdpdu',
      email: 'Ezekiel_Shanahan84@yahoo.com',
      name: 'Diana Nitzsche',
      shippingAddress: [
        {
          _id: false,
      ...
      userType: 544,
      mobileNo: '(367) 408-6462',
      resetPasswordLink: {},
      loginRetryLimit: 678,
      loginReactiveTime: '2023-12-01T14:07:18.479Z',
      id: '649211ddb628786f006cafc0'
    });
  }
  catch (error) {
...
describe('POST /register -> if email and username is given', () => {
  test('should register a user', async () => {
    let registeredUser = await request(app)
      ...
      .send({
        'username':'Zetta_Littel',
        'password':'pHnMQ089p3PUWrW',
        'email':'Eldon.Tromp@gmail.com',
        'name':'Dixie Quigley',
        'shippingAddress':[{
          '_id':false,
          'pincode':'Aruban',
...
describe('POST /forgot-password -> if email passed from request body is valid and OTP sent successfully', () => {
  test('should return success message', async () => {
    let user = await request(app)
      .post('/device/auth/forgot-password')
      .send({ 'email':'Eldon.Tromp@gmail.com', });
